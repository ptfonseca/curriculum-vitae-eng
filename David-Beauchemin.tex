...
\begin{tabular}{L!{\VRule}R}
  ...
  \multirow{1}{*}{\includegraphics[scale=0.1]{images/UL_P.pdf} \tab[0.6cm]} &  Université Laval \\
	...
	\multirow{1}{*}{\includegraphics[scale=0.1]{images/UL_P.pdf} \tab[0.6cm]}  &  Université Laval \\[-6pt]
\end{tabular}
...
2020 -- \tab[.7cm]   &{\bf {Chercheur en IA appliquée en traitement automatique du langage naturel}}\\
	\multirow{1}{*}{\includegraphics[scale=0.075]{images/Baseline.png} \tab[1.1cm]}					& Coopérative Baseline en intelligence artificielle\\
...
\multirow{1}{*}{\includegraphics[scale=0.1]{images/UL_P.pdf} \tab[0.6cm]}  &  Université Laval, GRAAL \\
...
2019 -- \tab[.7cm]  & \textbf{\href{https://www.dotlayer.org/}{.Layer}} \\
	\multirow{1}{*}{\includegraphics[scale=0.055]{images/DotLayer.png} \tab[1cm]}& Vice-président aux développements des affaires\\
	& Québec, Canada\\
	&\\
	&\\[-6pt]                      
