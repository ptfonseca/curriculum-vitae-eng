...
\begin{tikzpicture}[remember picture, overlay]
   \node[anchor=north west,inner sep=11.8pt] at (current page.north west)
...
\colorbox{shade}{
\begin{tabular}{m{7cm}} 
\Letter \,\, pedro.teles.fonseca@outlook.com\\
...
\colorbox{shade}{
\begin{tabular}{m{7cm}}
\includegraphics[scale=.11]{images/in.png} \,\,  \url{linkedin.com/in/pedro-teles-fonseca}\\
\includegraphics[scale=.038]{images/git.png} \,\, \url{github.com/pedro-teles-fonseca} \\
 \\
\end{tabular}
}
