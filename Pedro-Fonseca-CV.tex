...
\multicolumn{2}{r}{\includegraphics[scale=.11]{images/in.png} \,\, \url{linkedin.com/in/pedro-teles-fonseca}} \,\, & \multicolumn{2}{l}{\raisebox{-1pt}{\includegraphics[scale=.038]{images/git.png}} \,\, \url{github.com/pedro-teles-fonseca}}
\end{tabular}
}
