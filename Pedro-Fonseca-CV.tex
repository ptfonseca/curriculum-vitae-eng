...
% url color and font
%-----------------------------------------------
\usepackage[colorlinks,urlcolor=linkcolor,bookmarks=false,hypertexnames=true]{hyperref}
\urlstyle{same} 
...
\begin{tabular}{L!{\VRule}R}
\textbf{Programming}  & R, SQL, Bash, SAS, VBA, Wolfram, Python, Git and GitHub\\
...
\textbf{Software}         & R Studio, Excel, Word, Power Point, Teams, Zoom, Math Type, Solver, Eviews, Stata, MATLAB, Base SAS, SAS Enterprise Guide, SAS Enterprise Miner, SAS Studio, SQL Server, Wolfram Mathematica, VirtualBox, Visual Studio Code, JAGS, Stan. 
\end{tabular}
