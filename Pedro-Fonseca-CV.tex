...
\begin{tabular}{lr}
	...
	\begin{tabular}{m{7cm}} 
	\Telefon \,\, +351 ** ** ***  \\
	\Letter \,\, \href{mailto: pedro.teles.fonseca@phd.iseg.ulisboa.pt}{pedro.teles.fonseca@phd.iseg.ulisboa.pt}\\
...
\colorbox{shade}{
	\begin{tabular}{m{7cm}}
		\raisebox{-2pt}{\includegraphics[scale=.13]{images/in.png}} \,\,  \href{https://www.linkedin.com/in/pedro-teles-fonseca/}{linkedin.com/in/pedro-teles-fonseca}\\
	\raisebox{-3pt}{\includegraphics[scale=.04]{images/git.png}} \,\, \href{https://github.com/pedro-teles-fonseca}{github.com/pedro-teles-fonseca} \\
...
2017 -- \tab[.7cm]   &{\bf {FCT - Foundation for Science and Technology}}\\
				       &{\textbf{Research fellow}}\\
                        & Conducting research in order to obtain a PhD. Research field: Bayesian hypothesis testing. Working on applications that include fraud detection and bibliometrics.\\
...
%\begin{tabular}{L!{\VRule}R}
%
%\textsc{2020 &  Fonseca, Pedro and Rui Paulo (2020). pcal: Calibration of P-values for Point Null Hypothesis Testing. R package available for download on CRAN. Official website: https://pedro-teles-fonseca.github.io/pcal/.\\}
%
%\end{tabular}
...
2020   & \textbf{R/Medicine}, Virtual conference\\
